      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span6 offset3">
            <h4 class="widget-header"><i class="icon-lock"></i>About You</h4>
            <div class="widget-body">
              <div class="center-align">
                  <form class="form-horizontal form-signin-signup" action="profile_setup1.jsp">
                  <input type="text" name="name" placeholder="Name" required>
                  <input type="text" name="designation" placeholder="Designation" required>
                  <input type="text" name="designation" placeholder="Placeholder" required>
                  <input type="text" name="designation" placeholder="Placeholder" required>
